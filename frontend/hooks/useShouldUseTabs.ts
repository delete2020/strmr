...
export const useShouldUseTabs = () => {
  ...
  return useMemo(() => {
    // On mobile devices (non-TV iOS/Android), always use tabs regardless of breakpoint
    // This ensures consistent navigation on phones even with larger screen widths
